...
class Results(Page):
    ...
    def vars_for_template(player: Player):
        ...
        player.opponent_type = 'type 1' if opponent.player_role == 'rich' else 'type 2'
...
page_sequence = [Introduction, AssignRoleWaitPage, Game1Instructions, MatchInPairsWaitPage, Decision,
